...
public class LearnerCourseServiceTest {
	...
	public void init() {
		learner = new Learner();
		learner.setId(1);
		learner.setName("David Miller");
		learner.setContact("6543210987");
	...
	public void getCoursesByLearnerIdTest() {
		...
		course.setId(1);
		course.setTitle("Full Stack Java Spring Boot React");
	...
	// @Test
	public void getCourseByLearerIdTest() {
	...
	public void enrollLearnerInCourse() {
		...
		/** Actual */
		assertEquals(learnerCourse, learnerCourseService.enrollLearnerInCourse(100, 50, lc));
	...
	@AfterEach
	// After each test case, the objects used in them will get nullified and HEAP memory will be free
